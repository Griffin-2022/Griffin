...
Unlike other DBMS fuzzers relying on the grammar of DBMS's input (such as SQL) to build AST for generation or parsers for mutation,
...
# Tested DBMSs and Their Built-in Test Cases

The versions of tested DBMSs are shown as submodules in the root directory of the repository.
